...
let portfolioElements = [
    {
        ...
        text: 'Brandys Leather Workshop занимается изготовлением изделий ручной работы из натуральной кожи. Премиальное качество, долговечность, уникальный стиль. Стоимость разработки такого сайта начинается от 32 000 рублей, срок - от 10 дней.',
    ...
    },
    {
        ...
        text: 'Сайт стоматологической клиники с информацией о ней, а также возможностью записаться на приём и посмотреть информацию о врачах и услугах. Стоимость разработки такого лендинга - от 28 000 руб., срок - от 5 дней.',
    ...
    },
    {
        ...
        text: 'Одностраничный сайт спа-салона с информацией об услугах и возможностью записи на приём. Стоимость разработки такого лендинга - от 28 000 руб., срок - от 5 дней.',
...
let howtoElements = [
    ...
    },
    {
        ...
        text: 'Переходим к созданию дизайна. На основании проведенного анализа и ваших предпочтений отрисовываем сам макет, а также адаптивные версии, всплывающие окна, состояния интерактивных элементов. Оформляем всё это в презентацию и снова согласовываем с вами.'
    },
    {
        heading: 'ШАГ 4. Верстка и программирование',
        text: 'Начинается техническая часть разработки сайта. Верстаем полученный дизайн, программируем интерактивные элементы (меню, калькуляторы, и т.п.). Настраиваем отправку форм, анимируем элементы.'
    },
    {
        heading: 'ШАГ 5. Сдача проекта',
        text: 'Публикуем сайт на хостинге, подключаем выбранное доменное имя. Добавляем сайт в поисковые системы. Всё готово! Вы полноценный владелец вашего собственного сайта.'
    }
];
